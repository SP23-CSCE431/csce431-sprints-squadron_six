...
RSpec.describe "Viewing Exam Calendar", type: :feature do
  ...
  scenario 'admin, squad, valid inputs' do
    # create with another user, check that it's there on squad and not on personal
  end

  # rainy day admin can see squad on personal
  scenario 'admin, personal, see squad' do
    # create with another user, check that not on personal
end

...
RSpec.describe(Alumni, type: :model) do
  subject do
    ...
    company2 = Company.create(company_name: 'Apple', company_location: 'Houston',
                              company_industry: 'Softwares/Hardwares')
    described_class.new(company_id: company1.id, user_id: 123_456)
  end

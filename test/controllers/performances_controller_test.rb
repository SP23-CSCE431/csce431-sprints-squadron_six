...
class PerformancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performance" do
    assert_difference("Performance.count") do
      post performances_url, params: { performance: { exam_id: @performance.exam_id, performance_points: @performance.performance_points, user_id: @performance.user_id } }
    end
  ...
  test "should update performance" do
    patch performance_url(@performance), params: { performance: { exam_id: @performance.exam_id, performance_points: @performance.performance_points, user_id: @performance.user_id } }

...
class AlumnisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create alumni" do
    assert_difference("Alumni.count") do
      post alumnis_url, params: { alumni: { company_id: @alumni.company_id, user_id: @alumni.user_id } }
    end
  ...
  test "should update alumni" do
    patch alumni_url(@alumni), params: { alumni: { company_id: @alumni.company_id, user_id: @alumni.user_id } }
